...
def run():
    while True:
        ...
        if button_play_game or button_play_again:
            ...
            print("Гра почалась! Чекаємо 3 секунди на завантаження.")
            sleep(3)  # Затримка на 3 секунди перед пошуком космонавта
            ...
            while True:
                ...
                if cosmonavt:
                    ...
                    print("Космонавт не знайдений. Чекаємо 2 секунди перед повторним пошуком.")
                    sleep(2)  # Затримка на 2 секунди перед повторним пошуком космонавта
